            ...
            <?php foreach ($clips as $clip) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="update_performance.php?id=<?php echo $clip->getId(); ?>" class="btn btn-warning btn-sm float-right ml-2">Edit</a>

                    </td>
                    <td>
                        <video width="320" height="240" controls>
                            <source src="<?= $clip->getRevelClipUrl(); ?>" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <a href="update_reveal.php?id=<?php echo $clip->getId(); ?>" class="btn btn-warning btn-sm float-right ml-2">Edit</a>
